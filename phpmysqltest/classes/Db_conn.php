...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'rdabbaghian';//this will be your WCC username
      $dbUsr = 'rdabbaghian';//this will be your WCC username
      $dbPass = '9hBryArU5DHD';//this will be the password found in the video.
